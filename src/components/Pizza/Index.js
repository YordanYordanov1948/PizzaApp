...
const Pica = (props) => {
  return (
    <Pizza>
      <Crust>
        <Cheese>
          {props.peperoniCount >= 1 && props.peperoniCount >= -1 && (
            <Peperoni1 />
          )}
          {props.peperoniCount >= 2 && props.peperoniCount >= -2 && (
            <Peperoni2 />
          )}
          {props.peperoniCount >= 3 && props.peperoniCount >= -3 && (
            <Peperoni3 />
          )}
          {props.peperoniCount >= 4 && props.peperoniCount >= -4 && (
            <Peperoni4 />
          )}
          {props.peperoniCount >= 5 && props.peperoniCount >= -5 && (
            <Peperoni5 />
          )}
          ...
          {props.mushroomCount >= 1 && props.mushroomCount >= -1 && (
            <Muschrooms />
          )}
          {props.mushroomCount >= 2 && props.mushroomCount >= -2 && (
            <Muschrooms1 />
          )}
          {props.mushroomCount >= 3 && props.mushroomCount >= -3 && (
            <Muschrooms2 />
          )}
          {props.mushroomCount >= 4 && props.mushroomCount >= -4 && (
            <Muschrooms3 />
          )}
          ...
          {props.tomatoesCount >= 1 && props.tomatoesCount >= -1 && (
            <Tomatoes />
          )}
          {props.tomatoesCount >= 2 && props.tomatoesCount >= -2 && (
            <Tomatoes1 />
          )}
