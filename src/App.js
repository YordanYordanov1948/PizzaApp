  ...
  return (
    <Container>
      ...
      <Option
        ...
        cheeseCount={cheeseCount}
        incrementPeperoni={() =>
          incrementPeperoni(peperoniCount, 5, () =>
            setPeperoniCount((peperoniCount) => peperoniCount + 1)
          )
        }
        decrementPeperoni={() =>
          decrementPeperoni(peperoniCount, 5, () =>
            setPeperoniCount((peperoniCount) => peperoniCount - 1)
          )
        }
        incrementOlive={() =>
          incrementOlive(oliveCount, 5, () =>
            setOliveCount((oliveCount) => oliveCount + 1)
          )
        }
        decrementOlive={() =>
          decrementOlive(oliveCount, 5, () =>
            setOliveCount((oliveCount) => oliveCount - 1)
          )
        }
        incrementMuschrooms={() =>
        ...
        incrementCheese={() =>
          incrementCheese(
            cheeseCount,
            setCheeseCount((cheeseCount) => cheeseCount + 1)
          )
        }
        decrementCheese={() =>
          decrementCheese(
